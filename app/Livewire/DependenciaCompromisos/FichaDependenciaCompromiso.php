...
class FichaDependenciaCompromiso extends Component
{
    ...
    public function mount(DependenciaCompromiso $dependencia_compromiso)
    {
        ...
        $this->unidad_medidas = is_string($dependencia_compromiso->unidad_medidas)
            ? json_decode($dependencia_compromiso->unidad_medidas, true)
            : ($dependencia_compromiso->unidad_medidas ?: []);
