...
<form
    ...
    <div id="fase3" class="border p-3 rounded-lg border-doradoins">
        ...
        <div class="mt-4">
                    ...
                    <div class="md:flex-col md:w-1/2 justify-stretch mb-4">
                        <div class="w-full">
                            ...
                            <x-text-input id="pre_year2021" wire:model="pre_year2021" wire:model.live="pre_year2021"
                                class="block mt-1 w-full" type="text" min="0" :value="old('pre_year2021')"
                                placeholder="Monto en $" x-mask:dynamic="$money($input, '.', ',', 2)"
                                wire:keyup="changeMY21Event($event.target.value)" />
                            <p class="font-bold text-red-600">
                                @error('pre_year2021')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="md:flex-col md:w-1/2">
                        <div class="w-full">
                            ...
                            <x-text-input id="pre_year2022" wire:model="pre_year2022" wire:model.live="pre_year2022"
                                class="block mt-1 w-full" type="text" min="0" :value="old('pre_year2022')"
                                placeholder="Monto en $" x-mask:dynamic="$money($input, '.', ',', 2)"
                                wire:keyup="changeMY22Event($event.target.value)" />
                            <p class="font-bold text-red-600">
                                @error('pre_year2022')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="md:flex-col md:w-1/2">
                        <div class="w-full">
                            ...
                            <x-text-input id="pre_year2023" wire:model="pre_year2023" wire:model.live="pre_year2023"
                                class="block mt-1 w-full" type="text" min="0" :value="old('pre_year2023')"
                                placeholder="Monto en $" x-mask:dynamic="$money($input, '.', ',', 2)"
                                wire:keyup="changeMY23Event($event.target.value)" />
                            <p class="font-bold text-red-600">
                                @error('pre_year2023')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="md:flex-col md:w-1/2">
                        <div class="w-full">
                            ...
                            <x-text-input id="pre_year2024" wire:model="pre_year2024" wire:model.live="pre_year2024"
                                class="block mt-1 w-full" type="text" min="0" :value="old('pre_year2024')"
                                placeholder="Monto en $" x-mask:dynamic="$money($input, '.', ',', 2)"
                                wire:keyup="changeMY24Event($event.target.value)" />
                            <p class="font-bold text-red-600">
                                @error('pre_year2024')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="md:flex-col md:w-1/2">
                        <div class="w-full">
                            ...
                            <x-text-input id="pre_year2025" wire:model="pre_year2025" wire:model.live="pre_year2025"
                                class="block mt-1 w-full" type="text" min="0" :value="old('pre_year2025')"
                                placeholder="Monto en $" x-mask:dynamic="$money($input, '.', ',', 2)"
                                wire:keyup="changeMY25Event($event.target.value)" />
                            <p class="font-bold text-red-600">
                                @error('pre_year2025')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="md:flex-col md:w-1/2">
                        <div class="w-full">
                            ...
                            <x-text-input id="pre_year2026" wire:model="pre_year2026" wire:model.live="pre_year2026"
                                class="block mt-1 w-full" type="text" min="0" :value="old('pre_year2026')"
                                placeholder="Monto en $" x-mask:dynamic="$money($input, '.', ',', 2)"
                                wire:keyup="changeMY26Event($event.target.value)" />
                            <p class="font-bold text-red-600">
                                @error('pre_year2026')
                                    {{ $message }}
                                @enderror
            ...
            {{-- Presupuesto por años 27 --}}
            <div class="mt-4">
                <div class="md:flex md:flex-row md:justify-between md:space-x-3">
                    <div class="md:flex-col md:w-1/2">
                        <div class="w-full">
                            {{-- 2027 --}}
                            <x-input-label for="pre_year2027" :value="__('2027')" class="uppercase" />
                            <x-text-input id="pre_year2027" wire:model="pre_year2027" wire:model.live="pre_year2027"
                                class="block mt-1 w-full" type="text" min="0" :value="old('pre_year2027')"
                                placeholder="Monto en $" x-mask:dynamic="$money($input, '.', ',', 2)"
                                wire:keyup="changeMY27Event($event.target.value)" />
                            <p class="font-bold text-red-600">
                                @error('pre_year2027')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="md:flex-col md:w-1/2">
                        <div class="w-full">
                            ...
                            <x-text-input id="presupuesto_ejercido" wire:model="presupuesto_ejercido" readonly
                                ...
                                class="block mt-1 w-full group-hover:select-none select-none" type="text" disabled
                                readonly :value="old('presupuesto_ejercido')" min="0"
            ...
            <div class="mt-4">
                <div class="md:flex md:flex-row md:justify-between md:space-x-3">
                    <div class="md:flex-col md:w-1/2">
                        <div class="w-full">
                            {{-- 2027 --}}
                            <x-input-label for="eval_year2027" :value="__('2027')" class="uppercase" />
                            <x-text-input id="eval_year2027" wire:model="eval_year2027"
                                wire:change="changeEVP27Event($event.target.value)" wire:model.live="eval_year2027"
                                class="block mt-1 w-full" type="number" min="0" step="10"
                                :value="old('eval_year2027')" placeholder="Porcentaje de Evaluación" />
                            <p class="font-bold text-red-600">
                                @error('eval_year2027')
                                    {{ $message }}
                                @enderror
        ...
        <div class="mt-4">
            <div class="relative" wire:ignore>
                ...
                <textarea wire:model="text_accion_realizada" wire:model.live="text_accion_realizada"
                    ...
                    id="text_accion_realizada" cols="15" rows="5" maxlength="1200"
                    class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-lime-500 dark:focus:border-lime-600 focus:ring-lime-500 dark:focus:ring-lime-600 rounded-md shadow-sm resize-none"
    ...
    <div id="meta5" class="border p-3 rounded-lg border-doradoins">
        {{-- Meta Alcanzada --}}
        <div
            class="bg-white dark:bg-teal-600 overflow-hidden shadow-sm sm:rounded-lg p-2 text-rosains border-b-pink-500 border-b-2 mt-3">
            Meta Alcanzada <br />
                    ...
                    <div class="md:flex-col md:w-1/2 justify-stretch mb-4">
                        <div>
                            ...
                            <x-text-input id="meta_year21" wire:model="meta_year21" wire:model.live="meta_year21"
                                class="block mt-1 w-full" min="0" :value="old('meta_year21')"
                                x-mask:dynamic="$money($input, '.', ',', 4)"
                                wire:keyup="changeEVM21Event($event.target.value)" placeholder="Meta Alcanzada" />
                            @error('meta_year21')
                                <p class="font-bold text-red-600">
                                    {{ $message }}
                                </p>
                    ...
                    <div class="md:flex-col md:w-1/2">
                        <div>
                            ...
                            <x-text-input id="meta_year22" wire:model="meta_year22" wire:model.live="meta_year22"
                                wire:keyup="changeEVM22Event($event.target.value)" class="block mt-1 w-full"
                                x-mask:dynamic="$money($input, '.', ',', 4)"
                                min="0" :value="old('meta_year22')" placeholder="Meta Alcanzada" />
                            @error('meta_year22')
                                <p class="font-bold text-red-600">
                                    {{ $message }}
                                </p>
                ...
                <div class="md:flex md:flex-row md:justify-between md:space-x-3">
                    <div class="md:flex-col md:w-1/2 justify-stretch mb-4">
                        ...
                        <x-text-input id="meta_year23" wire:model="meta_year23" wire:model.live="meta_year23"
                            wire:keyup="changeEVM23Event($event.target.value)" class="block mt-1 w-full"
                            x-mask:dynamic="$money($input, '.', ',', 4)" min="0" :value="old('meta_year23')" placeholder="Meta Alcanzada" />
                        @error('meta_year23')
                            <p class="font-bold text-red-600">
                                {{ $message }}
                            </p>
                    ...
                    <div class="md:flex-col md:w-1/2">
                        ...
                        <x-text-input id="meta_year24" wire:model="meta_year24" wire:model.live="meta_year24"
                            wire:keyup="changeEVM24Event($event.target.value)" class="block mt-1 w-full"
                            x-mask:dynamic="$money($input, '.', ',', 4)" min="0" :value="old('meta_year24')" placeholder="Meta Alcanzada" />
                        @error('meta_year24')
                            <p class="font-bold text-red-600">
                                {{ $message }}
                            </p>
            ...
            <div class="mt-4">
                <div class="md:flex md:flex-row md:justify-between md:space-x-3">
                    <div class="md:flex-col md:w-1/2 justify-stretch mb-4">
                        ...
                        <x-text-input id="meta_year25" wire:model="meta_year25" wire:model.live="meta_year25"
                            wire:keyup="changeEVM25Event($event.target.value)" class="block mt-1 w-full"
                            x-mask:dynamic="$money($input, '.', ',', 4)" min="0" :value="old('meta_year25')" placeholder="Meta Alcanzada" />
                        @error('meta_year25')
                            <p class="font-bold text-red-600">
                                {{ $message }}
                            </p>
                    ...
                    <div class="md:flex-col md:w-1/2">
                        ...
                        <div class="relative" wire:ignore>
                            ...
                            <x-text-input id="meta_year26" wire:model="meta_year26" wire:model.live="meta_year26"
                                wire:keyup="changeEVM26Event($event.target.value)" class="block mt-1 w-full"
                                x-mask:dynamic="$money($input, '.', ',', 4)" min="0" :value="old('meta_year26')" placeholder="Meta Alcanzada" />
                        </div>
                        @error('meta_year26')
                            <p class="font-bold text-red-600">
                                {{ $message }}
                ...
                <div class="mt-4">
                    <div class="md:flex md:flex-row md:justify-between md:space-x-3">
                        <div class="md:flex-col md:w-1/2 justify-stretch mb-4">
                            {{-- 2027 --}}
                            <x-input-label for="meta_year27" :value="__('2027')" class="uppercase" />
                            <x-text-input id="meta_year27" wire:model="meta_year27" wire:model.live="meta_year27"
                                wire:keyup="changeEVM27Event($event.target.value)" class="block mt-1 w-full"
                                x-mask:dynamic="$money($input, '.', ',', 4)" min="0" :value="old('meta_year27')" placeholder="Meta Alcanzada" />
                            @error('meta_year27')
                                <p class="font-bold text-red-600">
                                    {{ $message }}
                                </p>
                        ...
                        <div class="md:flex md:flex-row md:justify-between md:space-x-3">
                            <div class="md:flex-col md:w-1/2 justify-stretch mb-4">
                                ...
                                <x-text-input id="meta_acumulada" disabled wire:model="meta_acumulada"
                                    wire:model.live="meta_acumulada" class="block mt-1 w-full" x-mask:dynamic="$money($input, '.', ',', 4)"
                            ...
                            <div class="md:flex-col md:w-1/2">
                                <div class="relative" wire:ignore>
                                    ...
                                    <x-text-input id="beneficiarios" wire:model="beneficiarios"
                                        wire:model.live="beneficiarios" class="block mt-1 w-full" x-mask:dynamic="$money($input, '.', ',', 4)"
                                        min="0" :value="old('beneficiarios')" placeholder="Beneficiarios" />
                                </div>
                                <p class="font-bold text-red-600">
                                    @error('beneficiarios')
                                        {{ $message }}
                    ...
                    <div class="mt-4">
                        <div class="relative" wire:ignore>
                            ...
                            <select wire:model="fuente_informacion" multiple
                                wire:model.model.live="fuente_informacion"
                    ...
                    <div class="mt-4">
                        ...
                        <textarea wire:model="medio_verificacion" wire:model.live="medio_verificacion"
                            ...
                            id="medio_verificacion'" cols="15" rows="5" maxlength="1200"
                            class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-lime-500 dark:focus:border-lime-600 focus:ring-lime-500 dark:focus:ring-lime-600 rounded-md shadow-sm resize-none"
