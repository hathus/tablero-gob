<div class="min-h-screen flex flex-col bg-cover bg-center bg-no-repeat dark:bg-gray-800"
    style="background-image: url('/images/background.png');">
    <div class="py-6 flex-grow">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg border border-doradoins bg-gray-100 dark:bg-gray-800">
                @forelse ($dependencia_compromisos as $dependencia_compromiso)
                    <div x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                        :style="hover
                            ?
                            'background-color: white; background-image: url({{ asset('images/logo.png') }}); background-repeat: no-repeat; background-position: center right; background-size: contain; transition: background-image 0.3s ease;' :
                            'background-color: white; background-image: url({{ asset('images/logo1.png') }}); background-repeat: no-repeat; background-position: center right; background-size: contain; transition: background-image 0.3s ease;'"
                        class="p-6 text-gray-900 dark:text-slate-200 md:flex md:justify-between border border-doradoins md:items-center transition-transform duration-300 ease-in-out hover:scale-[1.01]">
