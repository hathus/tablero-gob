...
<form wire:submit.prevent="editCompromiso"
      x-data="{ loading: false }" {{-- showInputs y showForm eliminados --}}
    ...
    <div class="relative"> {{-- x-show y x-transition eliminados --}}
        <label for="compromiso_numero"
            ...
            compromiso</label>
        <input id="compromiso_numero" type="text" min="1" step="0.1"
               wire:model.defer="compromiso_numero"
    ...
    <div class="relative"> {{-- x-show y x-transition eliminados --}}
        ...
        <textarea
            x-on:keyup="$wire.longitud_nombre_compromiso++"
            wire:keyup="character_count"
            maxlength="250"
            wire:model.defer="compromiso_nombre"
            placeholder="Nombre del compromiso"
            id="compromiso_nombre" name="compromiso_nombre" rows="4" cols="50"
    ...
    <div class="relative" wire:ignore>
        ...
        <select
            ...
            wire:model.model.live="dependencia_id"
    ...
    <div class="relative" wire:ignore>
        ...
        <select multiple="multiple"
                wire:model="compromiso_dependencia_intervienen"
    ...
    <div>
        <button type="submit"
                class="uppercase w-full flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-sky-600 hover:bg-sky-700 text-white font-bold shadow-lg transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                :disabled="loading">
