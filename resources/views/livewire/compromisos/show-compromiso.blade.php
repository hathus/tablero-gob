        ...
        <div class="bg-gray-100 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg border border-gray-400">
            @forelse($compromisos as $compromiso)
                <div x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false"
                    ...
                    class="p-6 text-gray-900 dark:text-slate-200 md:flex md:justify-between border border-slate-400 md:items-center transition-transform duration-300 ease-in-out hover:scale-[1.01] hover:shadow-lg">
